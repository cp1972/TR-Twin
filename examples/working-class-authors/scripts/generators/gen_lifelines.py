...
OUT = sys.argv[2] if len(sys.argv) > 2 else 'examples/working-class-authors/figures/instances_lifelines.svg'
PAL = {
...
COL = PAL['lane']
rows = list(csv.DictReader(open('examples/working-class-authors/data/instances/instances_probe_demo.csv')))
inst = {}
for r in rows:
