...
OUT=sys.argv[2] if len(sys.argv)>2 else 'examples/working-class-authors/figures/control_capacity.svg'
YEAR=int(sys.argv[4]) if len(sys.argv)>4 else 1900
rows=list(csv.DictReader(open(sys.argv[3] if len(sys.argv)>3 else 'examples/working-class-authors/data/instances/control_parc_demo.csv')))
byA={}
